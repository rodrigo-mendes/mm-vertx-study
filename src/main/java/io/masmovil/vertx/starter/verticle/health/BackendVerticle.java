...
public class BackendVerticle extends AbstractVerticle {
    ...
    private io.vertx.ext.web.Router setupRouter() {
        io.vertx.ext.web.Router router = io.vertx.ext.web.Router.router(vertx);

        io.vertx.ext.healthchecks.HealthChecks checks = io.vertx.ext.healthchecks.HealthChecks.create(vertx).register("verticle-health", promise ->
        ...
        io.vertx.ext.healthchecks.HealthCheckHandler healthCheckHandler = io.vertx.ext.healthchecks.HealthCheckHandler.createWithHealthChecks(checks);
